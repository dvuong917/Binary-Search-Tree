...
class BSTree {
    private:
        ...
        bool search(Node* root, const string &key) const;
    public:
        /* Constructors */
        /* Default constructor */
        BSTree();
        ...
        Node* findParent(const Node* node) const;
        bool isLeaf(const Node* node) const;
        /* Searches for a string in the BST. If found, returns the node containing the string. Returns nullptr elsewise. */
